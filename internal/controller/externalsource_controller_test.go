...
var _ = Describe("ExternalSource Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ExternalSource")
			err := k8sClient.Get(ctx, typeNamespacedName, externalsource)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ExternalSource")
